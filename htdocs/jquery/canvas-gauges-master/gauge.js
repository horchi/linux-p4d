!(function (e) {
    ...
    function c(e) {
        return (
            e.majorTicks instanceof Array || (e.majorTicks = e.majorTicks ? [e.majorTicks] : []),
            e.majorTicks.length || (e.majorTicks.push(We.formatMajorTickNumber(e.minValue, e)), e.majorTicks.push(We.formatMajorTickNumber(e.maxValue, e))),
    ...
    function f(e, t) {
        var i = void 0,
            r = !1;
        return (
            (i = 0 === t.majorTicksDec ? Math.round(e).toString() : e.toFixed(t.majorTicksDec)),
            t.majorTicksInt > 1
                ? ((r = ~i.indexOf(".")),
                  ~i.indexOf("-") ? "-" + [t.majorTicksInt + t.majorTicksDec + 2 + (r ? 1 : 0) - i.length].join("0") + i.replace("-", "") : [t.majorTicksInt + t.majorTicksDec + 1 + (r ? 1 : 0) - i.length].join("0") + i)
                : i
        );
    }
    function m(e) {
    ...
    function x(e, t, i, r, o, n) {
        if (t.valueBox) {
            ...
            t.colorValueBoxShadow && ((e.shadowBlur = 1.2 * c), (e.shadowColor = t.colorValueBoxShadow)),
    ...
    function T(e) {
        var t = e.value,
            ...
            r = e.maxValue,
            o = 0.01 * (r - i);
        return { normal: t < i ? i : t > r ? r : t, indented: t < i ? i - o : t > r ? r + o : t };
    }
    ...
    function V(e, t) {
        ...
        return (
            e.maxRadius ||
                (e.maxRadius = e.max - t.borderShadowWidth - t.borderOuterWidth * i - t.borderMiddleWidth * i - t.borderInnerWidth * i + (t.borderOuterWidth ? 0.5 : 0) + (t.borderMiddleWidth ? 0.5 : 0) + (t.borderInnerWidth ? 0.5 : 0)),
            e.maxRadius
        );
    }
    function W(e, t) {
        var i = pe.pixelRatio,
            ...
            n = o - (t.borderOuterWidth * i) / 2 - (t.borderMiddleWidth * i) / 2 + 0.5,
            a = n - (t.borderMiddleWidth * i) / 2 - (t.borderInnerWidth * i) / 2 + 0.5,
            l = V(e, t),
            s = void 0,
            d = !1;
        e.save(),
            t.borderOuterWidth && ((d = We.drawShadow(e, t, d)), S(o, t.borderOuterWidth * i, e, t.colorBorderOuter, t.colorBorderOuterEnd)),
            t.borderMiddleWidth && ((d = We.drawShadow(e, t, d)), S(n, t.borderMiddleWidth * i, e, t.colorBorderMiddle, t.colorBorderMiddleEnd)),
            t.borderInnerWidth && ((d = We.drawShadow(e, t, d)), S(a, t.borderInnerWidth * i, e, t.colorBorderInner, t.colorBorderInnerEnd)),
            We.drawShadow(e, t, d),
            e.beginPath(),
    ...
    function O(e, t) {
        ...
        if (i) {
            ...
            for (e.save(); o < n; o++) {
                ...
                e.beginPath(),
                    e.rotate(Ae),
                    e.arc(0, 0, r, We.radians(t.startAngle + (l.from - t.minValue) / a), We.radians(t.startAngle + (l.to - t.minValue) / a), !1),
    ...
    function A(e, t) {
        ...
        for (
            e.lineWidth = pe.pixelRatio,
                ...
                e.save(),
                t.exactTicks ? ((o = t.maxValue - t.minValue), (r = s ? o / s : 0), (l = (Se.mod(t.majorTicks[0], s) || 0) * d)) : (r = s * (t.majorTicks.length - 1));
            a < r;
            ++a
        )
            (n = t.startAngle + l + a * (t.ticksAngle / r)) <= t.ticksAngle + t.startAngle && (e.rotate(We.radians(n)), e.beginPath(), e.moveTo(0, i), e.lineTo(0, i - 0.075 * e.max), C(e));
    }
    function P(e, t) {
        var i = e.max / 100;
    ...
    function M(e, t) {
        ...
        for (e.lineWidth = 2 * a, e.save(), o = t.colorMajorTicks instanceof Array ? t.colorMajorTicks : new Array(n).fill(t.colorStrokeTicks || t.colorMajorTicks), r = 0; r < n; ++r)
            (e.strokeStyle = o[r]), e.rotate(We.radians(B(t, t.exactTicks ? t.majorTicks[r] : r, n))), e.beginPath(), e.moveTo(0, i), e.lineTo(0, i - 0.15 * e.max), C(e);
    ...
    function N(e, t) {
        t.title && (e.save(), (e.font = We.font(t, "Title", e.max / 200)), (e.fillStyle = t.colorTitle), (e.textAlign = "center"), e.fillText(t.title, 0, -e.max / 4.25, 0.8 * e.max), e.restore());
    }
    function E(e, t) {
        t.units && (e.save(), (e.font = We.font(t, "Units", e.max / 200)), (e.fillStyle = t.colorUnits), (e.textAlign = "center"), e.fillText(We.formatContext(t, t.units), 0, e.max / 3.25, 0.8 * e.max), e.restore());
    }
    function _(e, t) {
        if (t.needle) {
            ...
            e.save(),
                ...
                (e.fillStyle = We.linearGradient(e, t.colorNeedle, t.colorNeedleEnd, l - s)),
                "arrow" === t.needleType
                    ? (e.beginPath(),
                      e.moveTo(-c, -s),
                      e.lineTo(-d, 0),
                      ...
                      e.fill())
                    : (e.beginPath(), e.moveTo(-c, l), e.lineTo(-c, s), e.lineTo(c, s), e.lineTo(c, l), e.closePath(), e.fill()),
                t.needleCircleSize &&
                    (e.restore(),
                    We.drawNeedleShadow(e, t),
                    t.needleCircleOuter && (e.beginPath(), e.arc(0, 0, n, 0, 2 * Oe, !0), (e.fillStyle = We.linearGradient(e, t.colorNeedleCircleOuter, t.colorNeedleCircleOuterEnd, n)), e.fill(), e.closePath()),
                    t.needleCircleInner && (e.beginPath(), e.arc(0, 0, a, 0, 2 * Oe, !0), (e.fillStyle = We.linearGradient(e, t.colorNeedleCircleInner, t.colorNeedleCircleInnerEnd, a)), e.fill(), e.closePath()),
                    e.restore());
        }
    }
    function R(e, t, i) {
    ...
    function I(e) {
        ...
        return { startAngle: r, endAngle: o };
    }
    function D(e, t) {
        var i = e.max / 100,
            r = V(e, t) - 5 * i,
        ...
        if (
            (e.save(),
            e.rotate(Ae),
            o && (e.beginPath(), e.arc(0, 0, s, We.radians(c) - d, We.radians(h) + d, !1), (e.strokeStyle = t.colorBarStroke), (e.lineWidth = 2 * l), e.stroke(), e.closePath()),
            n &&
                (e.beginPath(),
                ...
                t.barShadow &&
                    ...
                    (e.shadowOffsetX = 0),
                    (e.shadowOffsetY = 0),
                    e.arc(0, 0, r, We.radians(t.startAngle), We.radians(t.startAngle + t.ticksAngle), !1),
                    e.stroke(),
                    e.closePath(),
                    e.restore(),
                    e.rotate(Ae)),
    ...
    function F(e, t, i, r, o, n) {
        ...
        var l = t.borderRadius * a,
            ...
            T = !1;
        return (
            t.borderOuterWidth && ((T = We.drawShadow(e, t, T)), G(e, t.borderOuterWidth * a, l, i + (t.borderOuterWidth * a) / 2 - x, r + (t.borderOuterWidth * a) / 2 - x, s, u, t.colorBorderOuter, t.colorBorderOuterEnd), (x += 0.5 * a)),
            t.borderMiddleWidth &&
                ((T = We.drawShadow(e, t, T)),
                G(e, t.borderMiddleWidth * a, (l -= 1 + 2 * x), g + (t.borderMiddleWidth * a) / 2 - x, w + (t.borderMiddleWidth * a) / 2 - x, d + 2 * x, f + 2 * x, t.colorBorderMiddle, t.colorBorderMiddleEnd),
                (x += 0.5 * a)),
            t.borderInnerWidth &&
                ((T = We.drawShadow(e, t, T)),
                G(e, t.borderInnerWidth * a, (l -= 1 + 2 * x), b + (t.borderInnerWidth * a) / 2 - x, k + (t.borderInnerWidth * a) / 2 - x, c + 2 * x, m + 2 * x, t.colorBorderInner, t.colorBorderInnerEnd),
                (x += 0.5 * a)),
            We.drawShadow(e, t, T),
    ...
    function X(e, t, i, r, o, n) {
        ...
        var c = !!t.title,
            ...
            m = void 0,
            v = void 0;
        l ? ((m = ye(0.05 * d)), (f = ye(0.075 * d)), (v = ye(0.11 * d)), c && ((d -= f), (r += f)), h && (d -= m), u && (d -= v)) : ((m = f = ye(0.15 * s)), c && ((s -= f), (r += f)), h && (s -= m));
    ...
    function Y(e, t, i, r, o, n, a) {
        ...
        "progress" !== i && t.barStrokeWidth && ((e.lineWidth = u), (e.strokeStyle = t.colorBarStroke), e.stroke()),
            "progress" !== i && t.colorBar
                ? ((e.fillStyle = t.colorBarEnd ? We.linearGradient(e, t.colorBar, t.colorBarEnd, h, s, s ? p : b) : t.colorBar), e.fill())
                : "progress" === i && t.colorBarProgress && ((e.fillStyle = t.colorBarProgressEnd ? We.linearGradient(e, t.colorBarProgress, t.colorBarProgressEnd, w, s, s ? p : b) : t.colorBarProgress), e.fill()),
            e.closePath(),
    ...
    function $(e, t, i, r, o, n, a, l, s) {
        ...
        for (var B = w / (o - r); S < V; S++)
            (W = i[S]),
                (e.strokeStyle = M[S]),
                c
                    ? ((T = p + h - m - f + (r - W) * B), n && ((x = b + A), Z(e, x, T, ye(x - O), T)), a && ((x = b + P), Z(e, x, T, ye(x - O), T)))
                    : ((x = b + m + f - (r - W) * B), n && ((T = p + A), Z(e, x, T, x, ye(T - O))), a && ((T = p + P), Z(e, x, ye(T), x, T - O)));
    }
    function K(e, t) {
        ...
        if (
            ...
            (e.strokeStyle = t.colorStrokeTicks || s[0]),
                (a *= w),
                c
                    ? ((S = b + h - m - v + a / 2), (W = S - p - a), o && ((V = T = ye(g + x)), Q(e, T, S, V, W)), n && ((V = T = ye(g + y)), Q(e, T, S, V, W)))
                    : ((T = g + m + v - a / 2), (V = T + p + a), o && ((W = S = ye(b + x)), Q(e, T, S, V, W)), n && ((W = S = ye(b + y)), Q(e, T, S, V, W)));
        }
    }
    ...
    function ee(e, t) {
        ...
        if (s)
            if (t.exactTicks) for (var c = Se.mod(t.majorTicks[0], s) || 0; l < t.maxValue; l += s) c + l < t.maxValue && a.push(c + l);
    ...
    function te(e, t) {
        ...
        for (e.font = We.font(t, "Numbers", n / 200), e.lineWidth = 0, e.textAlign = "center"; k < g; k++)
            (e.fillStyle = A[k]),
                (O = t.majorTicks[k]),
                (W = t.exactTicks ? h * ((v[k] - t.minValue) / f) : (k * h) / (g - 1)),
                r
                    ? ((V = c + o - l - s - W + w / 3), b && ((e.textAlign = "right"), e.fillText(O, d + x - P, V)), p && ((e.textAlign = "left"), e.fillText(O, d + T + P, V)))
                    : (e.measureText(O).width, (S = d + l + s + W), b && e.fillText(O, S, c + x - P), p && e.fillText(O, S, c + T + w + P));
    }
    function ie(e, t) {
        if (t.title) {
            var i = e.barDimensions,
    ...
    function oe(e, t) {
        if (t.needle) {
            ...
            e.save(),
                We.drawNeedleShadow(e, t),
                r
                    ? ((y = ye(h + n - s - l - v)), f && ((w = ye(c + W)), (k = w + p), T(e, t, w, y, k, y, p)), m && ((w = ye(c + O)), (k = w - p), T(e, t, w, y, k, y, p, !0)))
                    : ((w = ye(c + s + l + v)), f && ((y = ye(h + W)), (x = y + p), T(e, t, w, y, w, x, p)), m && ((y = ye(h + O)), (x = y - p), T(e, t, w, y, w, x, p, !0))),
                e.restore();
        }
    }
    function ne(e, t, i, r) {
    ...
    function le(e, t, i, r, o, n, a, l) {
        ...
        (e.fillStyle = ne(e, t, a, l)),
            e.beginPath(),
            c
                ? (r > n && (d *= -1), e.moveTo(i - h, r), e.lineTo(i + h, r), e.lineTo(i + h, r + d), e.lineTo(i, n), e.lineTo(i - h, r + d), e.lineTo(i - h, r))
                : (i > o && (d *= -1), e.moveTo(i, r - h), e.lineTo(i, r + h), e.lineTo(i + d, r + h), e.lineTo(o, r), e.lineTo(i + d, r - h), e.lineTo(i, r - h)),
            e.fill(),
            e.closePath();
    }
    ...
    var fe = (function () {
        ...
        ve = {
            ...
            debounce: function (e) {
                for (var t = 0, i = 1; 1; t += i, i /= 2) if (e >= (7 - 4 * t) / 11) return -Math.pow((11 - 6 * t - 11 * e) / 4, 2) + Math.pow(i, 2);
            },
            elastic: function (e) {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.isObservable &&
                                    ...
                                    (new MutationObserver(this.observe.bind(this)).observe(document.body, { childList: !0, subtree: !0, attributes: !0, characterData: !0, attributeOldValue: !0, characterDataOldValue: !0 }),
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                for (var t = 0, i = e.length; t < i; t++) {
                                    ...
                                    else if (r.addedNodes && r.addedNodes.length) for (var o = 0, n = r.addedNodes.length; o < n; o++) setTimeout(this.process.bind(this, r.addedNodes[o]));
                                }
                            },
                        },
                        {
                                ...
                                return (
                                    ...
                                    this.isObservable
                                        ? ((n.observer = new MutationObserver(function (r) {
                                          ...
                                          n.observer.observe(e, { attributes: !0 }),
                                          n)
                                        : n
                                );
                            },
    ...
    var Se = (function (t) {
        function n(t) {
            ...
            if (
                ...
                t.borders || (t.borderInnerWidth = t.borderMiddleWidth = t.borderOuterWidth = 0),
                !t.renderTo)
            )
                        ...
                        },
                        {
                            ...
                            set: function (e) {
                                (e = Se.ensureValue(e, this.options.minValue)),
                                    ...
                                    he(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "value", e, this);
                            },
                            get: function () {
                            ...
                            value: function () {
                                try {
                                    ...
                                    this.canvas.commit(),
                                        ...
                                        oe(e.context, s),
                                        this.emit("beforeValueBox"),
                                        se.apply(void 0, [e.context, s, s.animatedValue ? this.options.value : this.value].concat(t(this.drawBox))),
                                        ce(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "draw", this).call(this);
                                } catch (e) {
                                    We.verifyError(e);
                                }
                                return this;
                    ...
                    [
                        {
                            ...
                            value: function (e) {
                                return (
                                    e.barStrokeWidth >= e.barWidth && (e.barStrokeWidth = ye(e.barWidth / 2)),
                                    (e.hasLeft = q("right", e)),
                                    (e.hasRight = q("left", e)),
    ...
    void 0 !== e && (e.LinearGauge = Ce),
        ...
        "undefined" != typeof module && Object.assign(e, { Collection: l, GenericOptions: we, Animation: ge, BaseGauge: Se, drawings: We, SmartCanvas: pe, DomObserver: be, vendorize: n });
