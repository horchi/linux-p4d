...
#### ATTENTION:
The import deletes at first all the data and import the dump. To append the dumped data you have to modify the SQL statements inside the dump files manually.
